...
namespace SonicWarehouseManagement.Server.Controllers
{
    ...
    public class SalesmanMastersController : ControllerBase
    {
        ...
        // To protect from overposting attacks, enable the specific properties you want to bind to, for
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost("checkDupSalesman/{salesmancode}")]
        public async Task<ActionResult<SalesmanMaster>> PostSalesmanMaster2(string salesmancode, SalesmanMaster salesmanMaster)
        {
            var salesman = _context.Salesman_Masters.Where(x => x.Salesman_Code == salesmancode).Count();
